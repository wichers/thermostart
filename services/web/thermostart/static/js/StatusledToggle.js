...
ts.StatusledToggle = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        this.listenTo(this.model, 'change:sl', function() {
            this.$('input[value=' + this.model.get('sl') + ']').iCheck('check');
        }, this);
